...
| **PlayerObject** | Per player, synced behaviour | Instance lifetime + persistence if combined with PlayerData | One UdonBehaviour per player | Complex per-player state with frequent updates |
