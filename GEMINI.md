...
- **`.gemini/rules/udonsharp-constraints.md`** — Blocked Features, Code Generation Rules, Attributes, Syncable Types
- **`.gemini/rules/udonsharp-networking.md`** — Ownership, Sync Modes, RequestSerialization, NetworkCallable
- **`.gemini/rules/udonsharp-sync-selection.md`** — Sync Pattern Decision Tree, Data Budget, Minimization

## Skills

`.gemini/skills/` から自動検出される。UdonSharp / VRC ワールド関連の作業時に、該当スキルの SKILL.md を読み込んでから着手すること。

| Skill | 用途 | 参照パス |
|-------|------|----------|
| `unity-vrc-udon-sharp` | UdonSharp コーディング、ネットワーキング、イベント、テンプレート | `.gemini/skills/unity-vrc-udon-sharp/SKILL.md` |
